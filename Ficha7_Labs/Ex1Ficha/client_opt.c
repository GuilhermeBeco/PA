...
const char *gengetopt_args_info_help[] = {
  ...
  "  -r, --request=STRING  Resquest",
  "  -d, --device=INT      devices",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->request_arg = NULL;
  args_info->request_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->request_help = gengetopt_args_info_help[4] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->request_arg));
  free_string_field (&(args_info->request_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->request_given)
    write_into_file(outfile, "request", args_info->request_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->request_given)
    {
      fprintf (stderr, "%s: '--request' ('-r') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:p:r:d:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'r':	/* Resquest.  */
          ...
          if (update_arg( (void *)&(args_info->request_arg), 
               &(args_info->request_orig), &(args_info->request_given),
              &(local_args_info.request_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "request", 'r',
              additional_error))
            goto failure;
