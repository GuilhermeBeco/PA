...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->key_help = gengetopt_args_info_help[5] ;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->message_given)
    {
      fprintf (stderr, "%s: '--message' ('-m') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:p:m:k:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'k':	/* key.  */
          ...
          if (update_arg( (void *)&(args_info->key_arg), 
              ...
              &(local_args_info.key_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "key", 'k',
              additional_error))
            goto failure;
